...
const stripInvisibleControls = (value: string) =>
  value.replace(/[\u200b-\u200f\u202a-\u202e\u2060-\u206f\ufeff]/g, '')

const truncateAtWord = (value: string, maxChars: number) => {
...
const stripLoggedOutXShell = (value: string) => {
...
export const sanitizeSourceText = (value: string | null | undefined, fallback = '', maxChars = 500) => {
